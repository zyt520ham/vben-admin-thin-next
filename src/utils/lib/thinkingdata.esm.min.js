    ...
    function str(e, t) {
      ...
      switch (
        ...
        case 'object':
          if (!c) return 'null';
          if (
            ((gap += indent), (s = []), '[object Array]' === Object.prototype.toString.apply(c))
          ) {
            for (o = c.length, r = 0; r < o; r += 1) s[r] = str(r, c) || 'null';
            return (
              (i =
                0 === s.length
                  ? '[]'
    ...
    'function' != typeof Date.prototype.toJSON &&
      ...
      'function' != typeof JSON.stringify &&
        ...
        (JSON.stringify = function (e, t, r) {
          ...
          if (
            ((rep = t),
            t && 'function' != typeof t && ('object' !== _typeof(t) || 'number' != typeof t.length))
          )
...
var Config = { LIB_VERSION: '1.3.0' },
  ...
  _ = {
    each: function (e, t, r) {
      if (null !== e)
        if (nativeForEach && e.forEach === nativeForEach) e.forEach(t, r);
          ...
          for (var o in e)
            if (hasOwnProperty.call(e, o) && t.call(r, e[o], o, e) === breaker) return;
    },
    extend: function (e) {
      return (
        _.each(slice.call(arguments, 1), function (t) {
    ...
    formatJsonString: function (e) {
      try {
        return JSON.stringify(e, null, 8);
      } catch (t) {
    ...
    searchObjDate: function (e) {
      (_.check.isObject(e) || _.check.isArray(e)) &&
        _.each(e, function (t, r) {
          _.check.isObject(t) || _.check.isArray(t)
            ? _.searchObjDate(e[r])
            : _.check.isDate(t) && (e[r] = _.formatDate(t));
        });
    },
  };
(_.check = {
      ...
      var r =
        ...
        (function () {
          ...
          for (e = 0; e < r.length; e++)
            (t = r.charCodeAt(e)), n.unshift(255 & t), n.length >= 4 && ((i = o(i, n)), (n = []));
          return n.length > 0 && (i = o(i, n)), i.toString(16);
        })() +
        '-' +
        t +
        '-' +
        e();
      return (
        r || (String(Math.random()) + String(Math.random()) + String(Math.random())).slice(2, 15)
      );
    };
  })()),
  (_.UUIDv4 = function () {
  ...
  (_.getReferrer = function (e) {
    ...
    return 'string' != typeof t
      ...
      : (0 === t.indexOf('https://www.baidu.com/') && (t = t.split('?')[0]),
        'string' == typeof (t = t.slice(0, MAX_REFERRER_STRING_LENGTH)) ? t : '');
  }),
  (_.url = (function () {
    function e() {
      return new RegExp(
    ...
    function r(e, t) {
      for (
        ...
        if (
          ((o = i[u].match(/(.*?)=(.*)/)) || (o = [i[u], i[u], '']), '' !== o[1].replace(/\s/g, ''))
        ) {
          if (
            ((o[2] = ((r = o[2] || ''), _.decodeURIComponent(r.replace(/\+/g, ' ')))), c === o[1])
          )
            return o[2];
          (a = o[1].match(/(.*)\[([0-9]+)\]/))
            ? ((s[a[1]] = s[a[1]] || []), (s[a[1]][a[2]] = o[2]))
            : (s[o[1]] = o[2]);
        }
      return n === e ? s : s[c];
    }
    return function (n, i) {
      var o,
        s = {};
      if ('tld?' === n) return e();
      if (((i = i || window.location.toString()), !n)) return i;
      if (((n = n.toString()), (o = i.match(/^mailto:([^\/].+)/))))
        (s.protocol = 'mailto'), (s.email = o[1]);
      else {
        if (
          ((o = i.match(/(.*?)\/#\!(.*)/)) && (i = o[1] + o[2]),
          (o = i.match(/(.*?)#(.*)/)) && ((s.hash = o[2]), (i = o[1])),
          s.hash && n.match(/^#/))
        )
          return r(n, s.hash);
        if (
          ((o = i.match(/(.*?)\?(.*)/)) && ((s.query = o[2]), (i = o[1])),
          s.query && n.match(/^\?/))
        )
          return r(n, s.query);
        if (
          ((o = i.match(/(.*?)\:?\/\/(.*)/)) && ((s.protocol = o[1].toLowerCase()), (i = o[2])),
          (o = i.match(/(.*?)(\/.*)/)) && ((s.path = o[2]), (i = o[1])),
          (s.path = (s.path || '').replace(/^([^\/])/, '/$1').replace(/\/$/, '')),
          n.match(/^[\-0-9]+$/) && (n = n.replace(/^([^\/])/, '/$1')),
          n.match(/^\//))
        )
          return t(n, s.path.substring(1));
        if (
          ((o = t('/-1', s.path.substring(1))) &&
            (o = o.match(/(.*?)\.(.*)/)) &&
            ((s.file = o[0]), (s.filename = o[1]), (s.fileext = o[2])),
          (o = i.match(/(.*)\:([0-9]+)$/)) && ((s.port = o[2]), (i = o[1])),
          (o = i.match(/(.*?)@(.*)/)) && ((s.auth = o[1]), (i = o[2])),
          s.auth &&
            ((o = s.auth.match(/(.*)\:(.*)/)),
            (s.user = o ? o[1] : s.auth),
            (s.pass = o ? o[2] : void 0)),
          ...
          return t(n, s.hostname);
        e() &&
          (o = s.hostname.match(e())) &&
          ((s.tld = o[3]),
          (s.domain = o[2] ? o[2] + '.' + o[3] : void 0),
          (s.sub = o[1] || void 0)),
          (s.port = s.port || ('https' === s.protocol ? '443' : '80')),
          (s.protocol = s.protocol || ('443' === s.port ? 'https' : 'http'));
      }
  ...
  (_.encodeURIComponent = function (e) {
    var t = '';
    try {
  ...
  (_.utf8Encode = function (e) {
    ...
    for (
      ...
      s < 128
        ...
        null !== a && (r > t && (o += e.substring(t, r)), (o += a), (t = r = i + 1));
    }
  ...
  (_.base64Encode = function (e) {
    ...
    do {
      (t =
        ((o = (e.charCodeAt(a++) << 16) | (e.charCodeAt(a++) << 8) | e.charCodeAt(a++)) >> 18) &
        63),
        (r = (o >> 12) & 63),
        (n = (o >> 6) & 63),
        (i = 63 & o),
        (p[c++] = s.charAt(t) + s.charAt(r) + s.charAt(n) + s.charAt(i));
    } while (a < e.length);
  ...
  (_.cookie = {
    ...
    set: function (e, t, r, n, i) {
      ...
      i && (a = '; secure');
      var p = e + '=' + encodeURIComponent(t) + s + '; path=/' + o + a;
  ...
  (_.stripEmptyProperties = function (e) {
    ...
    return (
      _.each(e, function (e, r) {
        _.check.isString(e) && e.length > 0 && (t[r] = e);
      }),
      t
    );
  }),
  (_.info = {
    ...
    browser: function () {
      ...
      try {
        var t = navigator.userAgent.toLowerCase(),
          r = [];
        if (
          (null !== t.match(/baidubrowser/)
            ? ((e.type = 'baidu'), r.push(/baidubrowser\/([\d.]+)/))
            : null !== t.match(/bidubrowser/)
            ? ((e.type = 'baidu'), r.push(/bidubrowser\/([\d.]+)/))
            : null !== t.match(/edga/)
            ? ((e.type = 'edge'), r.push(/edga\/([\d.]+)/))
            : null !== t.match(/edgios/)
            ? ((e.type = 'edge'), r.push(/edgios\/([\d.]+)/))
            : null !== t.match(/liebaofast/)
            ? ((e.type = 'liebao'), r.push(/liebaofast\/([\d.]+)/))
            : null !== t.match(/sogoumobilebrowser/)
            ? ((e.type = 'sogou'), r.push(/sogoumobilebrowser\/([\d.]+)/))
            : null !== t.match(/lbbrowser/)
            ? ((e.type = 'liebao'), r.push(/lbbrowser\/([\d.]+)/))
            : null !== t.match(/crios/)
            ? ((e.type = 'chrome'), r.push(/crios\/([\d.]+)/))
            : null !== t.match(/qihoobrowser/)
            ? ((e.type = '360'), r.push(/qihoobrowser\/([\d.]+)/))
            : null !== t.match(/mxios/)
            ? ((e.type = 'maxthon'), r.push(/mxios\/([\d.]+)/))
            : null !== t.match(/fxios/)
            ? ((e.type = 'firefox'), r.push(/fxios\/([\d.\w]+)/))
            : null !== t.match(/edge/)
            ? ((e.type = 'edge'), r.push(/edge\/([\d.]+)/))
            : null !== t.match(/metasr/)
            ? ((e.type = 'sogou'), r.push(/metasr ([\d.]+)/))
            : null !== t.match(/micromessenger/)
            ? ((e.type = 'micromessenger'), r.push(/micromessenger\/([\d.]+)/))
            : null !== t.match(/mqqbrowser/)
            ? ((e.type = 'qq'), r.push(/mqqbrowser\/([\d.]+)/))
            : null !== t.match(/qqbrowserlite/)
            ? ((e.type = 'qq'), r.push(/qqbrowserlite\/([\d.]+)/))
            : null !== t.match(/tencenttraveler/)
            ? ((e.type = 'qq'), r.push(/tencenttraveler\/([\d.]+)/))
            : null !== t.match(/qqbrowser/)
            ? ((e.type = 'qq'), r.push(/qqbrowser\/([\d.]+)/))
            : null !== t.match(/maxthon/)
            ? ((e.type = 'maxthon'), r.push(/maxthon\/([\d.]+)/))
            : null !== t.match(/ubrowser/)
            ? ((e.type = 'uc'), r.push(/ubrowser\/([\d.]+)/))
            : null !== t.match(/ucbrowser/)
            ? ((e.type = 'uc'), r.push(/ucbrowser\/([\d.]+)/))
            : null !== t.match(/firefox/)
            ? ((e.type = 'firefox'), r.push(/firefox\/([\d.]+)/))
            : null !== t.match(/opera/)
            ? ((e.type = 'opera'), r.push(/opera\/([\d.]+)/))
            : null !== t.match(/opr/)
            ? ((e.type = 'opera'), r.push(/opr\/([\d.]+)/))
            : null !== t.match(/chrome/)
            ? ((e.type = 'chrome'), r.push(/chrome\/([\d.]+)/))
            : null !== t.match(/safari/)
            ? ((e.type = 'safari'), r.push(/version\/([\d.]+)/))
            : (null === t.match(/trident/) && null === t.match(/msie/)) || (e.type = 'ie'),
          'ie' === e.type)
        ) {
          var n = t.match(/trident\/([\d.]+)/) ? t.match(/trident\/([\d.]+)/)[1] : '',
            i = t.match(/msie ([\d.]+)/) ? t.match(/msie ([\d.]+)/)[1] : '';
          '' !== n ? (e.version = String(parseInt(n) + 4)) : '' !== i && (e.version = i);
        } else r && (e.version = t.match(r[0]) ? t.match(r[0])[1] : '');
      } catch (e) {
    ...
    pageProperties: function () {
      ...
      return _.stripEmptyProperties({
        '#referrer': e,
        '#referrer_host': e ? _.url('hostname', e) : e,
        '#url': location.href,
...
var Log = (function () {
      ...
      _createClass(e, null, [
              ...
              ? (_.each(e, function (e, t) {
                  _.check.isString(e) ||
                    ...
                    Log.w(
                      ...
                      t,
                      e,
                      '-格式不满足要求，可能无法正确入库. 属性值只支持 String, Number, Date, Boolean, Array',
                    );
                }),
                e)
              : e;
        ...
        },
        {
          ...
          value: function (e) {
            ...
            return (
              _.each(e, function (e, r) {
                KEY_NAME_MATCH_REGEX.test(r) || (Log.w('不合法的 KEY 值: ' + r), (t = !1));
              }),
              t
            );
          },
  ...
  ThinkingDataPersistence = function (e) {
    ...
    var t = null;
    if (this.enabled) {
      if (!1 === e.crossSubDomain) {
        var r = _.url('sub', location.href);
        this.name =
          'string' == typeof r && '' !== r
            ? e.persistencePrefix + '_' + r
            : e.persistencePrefix + '_root';
      } else this.name = e.persistencePrefix + '_cross';
      var n = e.persistence;
      'cookie' !== n &&
        'localStorage' !== n &&
        (Log.i('Unknown persistence type ' + n + '; falling back to cookie'),
        (n = e.persistence = 'cookie')),
        'localStorage' === n && _.localStorage.isSupported()
          ? ((this.storage = _.localStorage),
            (t = _.cookie.get(this.name)) && _.cookie.remove(this.name, this.crossSubDomain))
          : (Log.i('localStorage is not support by the browser; falling back to cookie'),
            (this.storage = _.cookie));
    }
    if ((this._load(t), !this.getDistinctId())) {
      var i = e.uuid ? e.uuid : _.UUID();
      this._setDeviceId(i), this.setDistinctId(i);
    }
  };
...
(ThinkingDataAnalyticsLib.prototype.trackLink = function (e, t, r) {
  var n = this,
    i = this._getConfig('strict');
  if (PropertyChecker.properties(r) || !i) {
    if (e && _.check.isObject(e)) {
      var o = [];
      _.each(e, function (e, t) {
        e &&
          _.check.isArray(e) &&
          _.each(e, function (e) {
            switch (t) {
              ...
              case 'id':
                ...
                null !== r && o.indexOf(r) < 0 && o.push(r);
            }
          });
      }),
        _.each(o, function (e) {
          if (null !== e) {
            var o = _.extend({}, _.info.pageProperties(), r);
            (o['#element_type'] = e.nodeName.toLowerCase()),
              _.check.isUndefined(o.name) &&
                (o.name = e.getAttribute('td-name') || e.innerHTML || e.value || '未获取标识'),
              e.addEventListener('click', function () {
                n._sendRequest({
                  type: 'track',
                  event: t,
                  properties: i ? PropertyChecker.stripProperties(o) : o,
                });
              });
          }
        });
    }
  } else Log.w('trackLink failed due to invalid properties.');
}),
  ...
  (ThinkingDataAnalyticsLib.prototype.logout = function (e) {
    if (!0 === e) {
      var t = _.UUID();
      this.persistence.setDistinctId(t);
    }
  ...
  (ThinkingDataAnalyticsLib.prototype.userUnset = function (e, t) {
    if (PropertyChecker.propertyName(e) || !this._getConfig('strict')) {
      var r = {};
      (r[e] = 0), this._sendRequest({ type: 'user_unset', properties: r }, t);
    }
  }),
  (ThinkingDataAnalyticsLib.prototype.userAdd = function (e, t) {
    if (_.check.isString(e)) {
      var r = e;
      (e = {})[r] = 1;
    }
  ...
  (ThinkingDataAnalyticsLib.prototype.userAppend = function (e, t) {
    (PropertyChecker.propertiesMust(e) &&
      (function (e) {
        for (var t in e) if (!_.check.isArray(e[t])) return !1;
        return !0;
      })(e)) ||
  ...
  (ThinkingDataAnalyticsLib.prototype.userDel = function (e) {
    this._sendRequest({ type: 'user_del' }, e);
  }),
  (ThinkingDataAnalyticsLib.prototype._sendRequest = function (e, t, r) {
    var n = _.check.isUndefined(e.time) || !_.check.isDate(e.time) ? new Date() : e.time,
      i = {
        data: [
          {
            '#type': e.type,
    ...
    if (
      (this.persistence.getAccountId() &&
        (i.data[0]['#account_id'] = this.persistence.getAccountId()),
      'track' === e.type)
    ) {
      (i.data[0]['#event_name'] = e.event),
        (i.data[0].properties = _.extend(
          {},
          {
            '#device_id': this.persistence.getDeviceId(),
            '#zone_offset': 0 - n.getTimezoneOffset() / 60,
          },
          _.info.properties(),
      ...
      var o = this.persistence.removeEventTimer(e.event);
      if (!_.check.isUndefined(o)) {
        var s = new Date().getTime() - o;
        i.data[0].properties['#duration'] = parseFloat((s / 1e3).toFixed(3));
      }
    } else i.data[0].properties = {};
    if (
      (_.check.isObject(e.properties) &&
        !_.check.isEmptyObject(e.properties) &&
        _.extend(i.data[0].properties, e.properties),
      _.searchObjDate(i.data[0]),
      (i['#app_id'] = this._getConfig('appId')),
      Log.i(i),
      this._getConfig('useAppTrack'))
    ) {
      var a = window.ThinkingData_APP_JS_Bridge || {};
      if ('object' === _typeof(a) && a.thinkingdata_track)
        return a.thinkingdata_track(JSON.stringify(i)), void ('function' == typeof t && t());
      if (/td-sdk-ios/.test(navigator.userAgent) && !window.MSStream) {
        var c = document.createElement('iframe');
        return (
          c.setAttribute(
            'src',
            'thinkinganalytics://trackEvent?event=' + _.encodeURIComponent(JSON.stringify(i)),
          ),
    ...
    r && (i.data[0]['#uuid'] = _.UUIDv4()), (i = JSON.stringify(i));
    var u = _.base64Encode(i),
      p = 'crc=' + _.hashCode(u),
      h = '&data=' + _.encodeURIComponent(u) + '&ext=' + _.encodeURIComponent(p);
    if ('ajax' === this._getConfig('send_method')) {
      var l = null;
      l = window.XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
      var f = this._getConfig('serverUrl');
      l.open('post', f, !0),
        l.setRequestHeader('Content-type', 'application/x-www-form-urlencoded'),
        (l.onreadystatechange = function () {
          4 === l.readyState && 200 === l.status && t && t();
        }),
        l.send(h);
    } else this._sendRequestWithImage(h, t);
    if (
      r &&
      void 0 !== ('undefined' == typeof navigator ? 'undefined' : _typeof(navigator)) &&
      navigator.sendBeacon
    ) {
      var g = new FormData();
      g.append('data', u), navigator.sendBeacon(this._getConfig('serverUrl'), g);
    }
  }),
  (ThinkingDataAnalyticsLib.prototype._sendRequestWithImage = function (e, t) {
    ...
    (i.callback = t),
      setTimeout(r, this._getConfig('dataSendTimeout'), i),
      (i.onload = function () {
  ...
  (ThinkingDataAnalyticsLib.prototype.track = function (e, t, r, n) {
    ((PropertyChecker.event(e) && PropertyChecker.properties(t)) || !this._getConfig('strict')) &&
      this._sendRequest(
        { type: 'track', event: e, time: _.check.isDate(r) ? r : new Date(), properties: t },
        n,
      );
  }),
  (ThinkingDataAnalyticsLib.prototype.trackWithBeacon = function (e, t, r, n) {
    ((PropertyChecker.event(e) && PropertyChecker.properties(t)) || !this._getConfig('strict')) &&
      this._sendRequest(
        { type: 'track', event: e, time: _.check.isDate(r) ? r : new Date(), properties: t },
        n,
  ...
  (ThinkingDataAnalyticsLib.prototype.setSuperProperties = function (e) {
    PropertyChecker.propertiesMust(e) || !this._getConfig('strict')
      ? this.persistence.setSuperProperties(e)
  ...
  (ThinkingDataAnalyticsLib.prototype.unsetSuperProperty = function (e) {
    if (_.check.isString(e)) {
      ...
      delete t[e], this.persistence.setSuperProperties(t);
    }
  }),
  ...
  (ThinkingDataAnalyticsLib.prototype.initInstance = function (e, t) {
    ...
    n.persistenceEnabled && (n.persistencePrefix = n.persistencePrefix + '_' + e),
      r.init(n),
      (this[e] = r);
  });
var td = initAsModule();
